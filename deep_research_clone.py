...
Original file is located at
    https://colab.research.google.com/drive/1cL6jCXjhSqh6angjesqWY0OOj1fgwani
"""
...
openai_api_key = userdata.get('genai')
...
topic = input("What is the topic of research? ")
topic

"""# LLM asks questions"""

# Define the prompt to clarify
prompt_to_clarify = f"""
...
def run_search(q):
  ...
  return {'query': q,
          "resp_id": web_search.output[1].content[0].text}
...
# Verifying if we have enough information
collected = []
...
report = client.responses.create(
    model=MODEL,
    input = [
        {"role": "developer", "content": (f"Write a complete and detail report about research goal: {goal}"
